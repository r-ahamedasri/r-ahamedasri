...
def daily_readme(birthday):
    """
    Returns the length of time since a given birthday
...
def svg_overwrite(filename, age_data, commit_data, star_data, repo_data, contrib_data, follower_data, loc_data):
    ...
    justify_format(root, 'star_data', star_data, 33)
    justify_format(root, 'repo_data', repo_data, 14)
    justify_format(root, 'contrib_data', contrib_data)
    justify_format(root, 'follower_data', follower_data, 29)
...
if __name__ == '__main__':
    """
    Ahamed Asri (r-ahamedasri) — adapted from Andrew Grant's (Andrew6rant) profile README generator
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2006, 1, 17))
